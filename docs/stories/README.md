...
See [C4 Component Diagram](../architecture/c4/03-component.md) for detailed internal structure.
...
3. Reference [C4 diagrams](../architecture/c4/) for architecture context
4. Check [ADRs](../architecture/decisions/) for design rationale
...
- **[C4 Architecture](../architecture/c4/)** - Visual architecture diagrams
