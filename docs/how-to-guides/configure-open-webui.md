...
**Why collections?** Same database, clear separation, zero vendor lock-in, full control. See [ADR-0006](../reference/architecture/decisions/0006-separate-systems-architecture.md) for full rationale.
...
- **[ADR-0006](../reference/architecture/decisions/0006-separate-systems-architecture.md)** - Why separate systems
