...
## References
- **Research doc:** [argument_based_chunking_for_philosophical_texts_alexandria_rag.md](../../../explanation/research/argument_based_chunking_for_philosophical_texts_alexandria_rag.md)
