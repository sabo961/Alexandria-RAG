...
**F0: Infrastructure** - Neo4j (Docker), Graphiti setup, Qdrant connector, MCP connector

**F1: Book Graph (static)** - Book nodes from Calibre, Author nodes + WROTE, concept extraction, CITES relationships

**F2: Relationship Discovery** - Concept linking, author influence mapping, school/period classification, cross-book mapping

**F3: User Journey Tracking** - User node, READ relationships with timestamp, SEARCHED log, FOUND_USEFUL feedback

**F4: Personalized Retrieval** - "Next book" recommendation, "already know" context, reading paths, knowledge gaps

**F5: Temporal Queries** - Understanding evolution, historical knowledge state, concept paths between books
