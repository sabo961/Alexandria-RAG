...
**F0: Infrastructure** - Auto-Claude setup, BMad Builder, MCP connector

**F1: LIBRARIAN (MVP)** - Agent persona, Calibre sync, metadata extraction, Qdrant pipeline

**F2: RESEARCHER** - Semantic search, cross-reference, synthesis, citations

**F3: CURATOR** - User context, recommendations, reading paths

**F4: ARCHIVIST** - Health checks, scheduled maintenance, quality metrics

**F5: Integration** - Dispatcher logic, inter-agent communication, external API
